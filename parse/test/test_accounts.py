...
from parse.accounts import accounts_from_superpositions

import check_function
from input_values import figure_superpositions

function = accounts_from_superpositions
...
def test_parses_known_accounts_to_expected_valid_accounts(account, expected_valid_accounts):
    ...
    found_accounts = accounts_from_superpositions(superpositions)
