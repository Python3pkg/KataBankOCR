...
class MakeEntryLines:
    "  methods that return a list of lines representing an account string "
    ...
    def containing_non_string(cls):
        " return (an otherwise valid) list containing one non-string "
    ...
    def abbreviated_string(cls):
        " return (an otherwise valid) list containing one abbreviated string "
    ...
    def extended_string(cls):
        " return (an otherwise valid) list containing one extended string "
